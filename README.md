...
- **Hosting**: Hostinger
- **Version Control**: [GitHub Repository](https://github.com/Justineeeeeeeee/Taskswap.3.git)
...
Full technical documentation is available in the PDF: [TaskSwap Technical Documentation](./TaskSwap-Technical-Documentation.pdf)

Prototype on Figma: [TaskSwap UX Design](https://www.figma.com/design/SxdgexckPc68xStVycEqbP/TaskSwap-Prototype?node-id=0%3A1)
