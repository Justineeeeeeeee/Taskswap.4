...
<div class="col-md-3 " >
    ...
    <div class="card" style="border-style: solid; border-color: #62AC83">
    ...
    <div class="mb-3 text-center" style="display: flex; align-items: center; justify-content: center;">
        ...
        <p class="text-center" style="display: flex; align-items: center; justify-content: center;">{{ $search->bio }} </p>
        ...
        <a href = "My Portfolio">
          <button class="btn btn-special"  type="submit" style="width:100%;font-weight:bold; font-family:Fira Sans, sans-serif; ">Portfolio</button>
          </a>
