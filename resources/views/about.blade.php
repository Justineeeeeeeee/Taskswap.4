...
@include('header')
  ...
  <section class="category-section">
      ...
      <div class="row featurette">
                <div class="col-md-7">
                    <h2 class="featurette-heading fw-normal lh-1" style="font-family:Fira Sans, sans-serif; ">About Us</h2>
                    <br>
                </div>
            </div>
            ...
            <div class="row featurette">
                <div>
                    <h2 class="featurette-heading fw-normal lh-1" style=" font-family:Fira Sans, sans-serif; ;font-size: 2.0em;">Our Vision <span>
