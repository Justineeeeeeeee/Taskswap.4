...
<div>
    <div>
        <h2 class="featurette-heading" style="font-family:Fira Sans, sans-serif; ">Privacy Policy for TaskSwap</h2>
    </div>
</div>

<div class="row featurette">
    <div>
        <h2 class="featurette-heading fw-normal lh-1" style="font-family: PT Serif, sans-serif">1. Information We Collect <span>
                <p class="lead" style="font-family: PT Serif, sans-seriffont-size: 20px;">
...
<div class="row featurette">
    <div>
        <h2 class="featurette-heading fw-normal lh-1" style="font-family: PT Serif, sans-serif; " >2. How We Use Your Information<span>
                <p class="lead" style="font-family: PT Serif, sans-serif; font-size: 20px;">
...
<div class="row featurette">
    <div>
        <h2 class="featurette-heading fw-normal lh-1" style="font-family: PT Serif, sans-serif">3. Information Sharing<span>
                <p class="lead" style="font-family: PT Serif, sans-serif;font-size: 20px;">
...
<div>
    <div>
        <h2 class="featurette-heading fw-normal lh-1" style="font-family: PT Serif, sans-serif">4. Security<span>
                <p class="lead" style="font-family: PT Serif, sans-serif; font-size: 20px; ">
...
<script>
        ...
        <div class="modal fade" id="terms-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
          ...
          <div class="modal-dialog  modal-dialog-centered" style="width:fit-content">
            ...
            <h2 class="h2_text" style="font-family:Fira Sans, sans-serif; ">Terms Of Service</h2>
